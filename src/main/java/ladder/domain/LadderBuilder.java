...
public class LadderBuilder {
    ...
    private static StringBuilder appendStepOrSpace(Row row, int booleanPosition) {
    ...
    private static StringBuilder determineLadderPart(Row row, int printCount) {
    ...
    private static StringBuilder buildRowString(Row row, String[] playerNames) {
    ...
    private static StringBuilder addRowsToString(ArrayList<Row> ladder, String[] playerNames) {
        for (Row row : ladder) {
    ...
    static StringBuilder addNamesToString(String[] playerNames) {
